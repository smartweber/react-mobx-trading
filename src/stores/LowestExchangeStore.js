...
class LowestExchangeStore {
  ...
  constructor(orderForm, orderBookStore, snackbar) {
...
export default (orderForm, orderBookStore, snackbar) => {
  const store = new LowestExchangeStore(orderForm, orderBookStore, snackbar);
  return store;
};
