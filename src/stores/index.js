...
export default once(() => {
  ...
  const exchangesStore = ExchangesStore(instrumentStore, settingsStore, snackbarStore.Snackbar, smsAuthStore);

  const viewModeStore = ViewModeStore(exchangesStore);
  ...
  const lowestExchangeStore = LowestExchangeStore(orderBookStore, snackbarStore.Snackbar);
