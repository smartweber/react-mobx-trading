...
const BillDetailPop = memo(({ level, publicKey, ownerId, onClose, setSafeTimeout, coinDepositAddress }) => {
      ...
      <Wrapper>
        <LeftDetails>
          ...
          <LeftQRCodeWrapper>
            ...
            <QRCode value={coinDepositAddress} fgColor="#000000A0" />
            <p>WITHDRAW OF THIS SMART CONTRACT WILL RETURN IT TO BTC WALLET</p>
            <p>{coinDepositAddress}</p>
          </LeftQRCodeWrapper>
        </LeftDetails>
