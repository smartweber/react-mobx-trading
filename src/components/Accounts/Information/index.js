...
function TopMenu({ selectedExchanges, onExchangeChange, marketExchanges, portfolioData }) {
...
const withStore = compose(
  ...
  observer,
  withProps(
    ({ [STORE_KEYS.EXCHANGESSTORE]: { marketExchanges }, [STORE_KEYS.YOURACCOUNTSTORE]: { portfolioData } }) => ({
      marketExchanges,
      portfolioData
    })
  )
