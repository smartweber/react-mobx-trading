...
class AccountSection extends React.PureComponent {
  ...
  handleExitFullScreen = () => {
    this.props.setRightBottomSectionOpenMode(MODE_KEYS.depthChartKey);
  };
...
export default compose(
  ...
  withProps(
    ({
      [STORE_KEYS.YOURACCOUNTSTORE]: { getExchangeBalances },
      [STORE_KEYS.VIEWMODESTORE]: { setRightBottomSectionOpenMode }
    }) => ({
      getExchangeBalances,
